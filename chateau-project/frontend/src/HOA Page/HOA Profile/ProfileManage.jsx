...
const ProfileManage = () => {
  ...
  // --- ADDED PERSONAL INFO UPDATE FUNCTION ---
            ...
            {activeSection === 'Personal Info' && (
              <div className="mt-12 flex justify-end gap-4 border-t border-slate-50 pt-8">
                ...
                <button 
                  ...
                  className="flex items-center gap-2 px-8 py-3.5 bg-indigo-600 text-white rounded-2xl text-sm font-bold hover:bg-indigo-700 shadow-lg shadow-indigo-200 transition-all disabled:opacity-50"
                >
